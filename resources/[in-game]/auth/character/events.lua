                ...
                function(qh,player)
                    ...
                    if rows > 0 then
                        for index, row in ipairs(res) do
                            player:spawn(row.x,row.y,row.z)
                            player:setInterior(tonumber(row.int))
                            player:setDimension(tonumber(row.dim))
            ...
            function(qh,player)
                ...
                if rows > 0 then
                    for index, row in ipairs(res) do
                        ...
                        data[i][2] = row.name
                        data[i][3] = tonumber(row.x)
                        data[i][4] = tonumber(row.y)
                        data[i][5] = tonumber(row.z)
